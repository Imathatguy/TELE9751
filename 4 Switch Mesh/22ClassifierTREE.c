...
#define INPUT_PORT 50010
#define OUTPUT_PORT 50011
...
int main() {
	...
	file = fopen("2clasEntry.txt", "r");	// open txt file to get pretermined tree entry
	if(file != NULL) {
...
void treeTable() {
	...
	int root1Branch, root2Branch, root3Branch, root4Branch, n1, n2, n3, n4, tempField, t1=50, t2=5, t3=3, t4=2;
	char tempBin[9];
	treeArray *prev = NULL;
